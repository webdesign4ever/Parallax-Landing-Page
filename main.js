...
//fake sending email to endpoint
...
// FADE UP OBSERVER //
function fadeUpObeserverCallback(elsToWatch) {
...
const fadeUpObeserverOptions = {
  threshold: .6,
};

const fadeUpObserver = new IntersectionObserver(
  fadeUpObeserverCallback,
  fadeUpObeserverOptions
);
